...
export const getContacts = (): ContactList[] => {
    return [
        {
            productName: 'Cool Product Bip',
            productLine: 'Bih',
            vaPm: ['George Washington', '555-555-5555', 'gw@va.gov'],
            bahPm: ['John Adams', '555-555-5555', 'ja@bah.com'],
            scrumMaster: ['Thomas Jefferson', '555-555-5555', 'tj@bah.com'],
            techLead: ['James Madison', '555-555-5555', 'jm@va.gov'],
        }
    ]
}